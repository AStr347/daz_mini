...
void DMA_DeInit(DMA_Channel_TypeDef *DMAy_Channelx)
{
    ...
    {
        case (u32)DMA1_Channel1: { DMA1->INTFCR |= DMA1_Channel1_IT_Mask; }break;
        case (u32)DMA1_Channel2: { DMA1->INTFCR |= DMA1_Channel2_IT_Mask; }break;
        case (u32)DMA1_Channel3: { DMA1->INTFCR |= DMA1_Channel3_IT_Mask; }break;
        case (u32)DMA1_Channel4: { DMA1->INTFCR |= DMA1_Channel4_IT_Mask; }break;
        case (u32)DMA1_Channel5: { DMA1->INTFCR |= DMA1_Channel5_IT_Mask; }break;
        case (u32)DMA1_Channel6: { DMA1->INTFCR |= DMA1_Channel6_IT_Mask; }break;
        case (u32)DMA1_Channel7: { DMA1->INTFCR |= DMA1_Channel7_IT_Mask; }break;

        case (u32)DMA2_Channel1: { DMA2->INTFCR |= DMA2_Channel1_IT_Mask; }break;
        case (u32)DMA2_Channel2: { DMA2->INTFCR |= DMA2_Channel2_IT_Mask; }break;
        case (u32)DMA2_Channel3: { DMA2->INTFCR |= DMA2_Channel3_IT_Mask; }break;
        case (u32)DMA2_Channel4: { DMA2->INTFCR |= DMA2_Channel4_IT_Mask; }break;
        case (u32)DMA2_Channel5: { DMA2->INTFCR |= DMA2_Channel5_IT_Mask; }break;
 ...
 * @return  none
 */
void DMA_Init(DMA_Channel_TypeDef *DMAy_Channelx, const DMA_InitTypeDef * const DMA_InitStruct)
{
    uint32_t tmpreg = 0;
